...
if (!NIM_API_KEY) {
  console.warn('WARNING: NIM_API_KEY environment variable is not set. The proxy will not function properly.');
}
  ...
  try {
    ...
    if (!nimModel) {
      try {
        ...
        console.debug('Model test failed, using fallback:', e.message);
      }
    ...
    const response = await axios.post(`${NIM_API_BASE}/chat/completions`, nimRequest, {
      ...
      timeout: 300000 // 5 minute timeout for long requests
    });
